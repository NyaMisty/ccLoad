...
window.I18N_LOCALES['en'] = {
  ...
  'channels.maxConcurrency': 'Per-Key Concurrency',
  ...
  'channels.modal.protocolTransformsHint': 'Expose extra protocols only, excluding the native upstream protocol',
  ...
  'tokens.channelTypeAll': 'All groups',
  'tokens.channelTypeFilterTitle': 'Filter channels by group',
  'tokens.channelTypeOther': 'Other',
  ...
  'modelTest.chat.thinkingXHighMax': 'Highest (xhigh/max)',
  ...
  'modelTest.addModelsInputLabel': 'Enter model names (comma or newline separated)',
  'modelTest.addModelsPlaceholder': 'gpt-4o,gpt-4o-mini\nclaude-3-5-sonnet-20241022\nclaude-3-5-haiku-latest',
  'modelTest.addModelsHelpTitle': 'Usage:',
  'modelTest.addModelsHelpComma': 'Comma separated:',
  'modelTest.addModelsHelpLine': 'Newline separated: one model per line',
  'modelTest.addModelsHelpDedupe': 'Whitespace, blank lines, and duplicate models are removed automatically',
  ...
  'modelTest.selectProtocolFirst': 'Please select a protocol transform first',
  'modelTest.selectModelFirst': 'Please select a model first',
  'modelTest.selectAtLeastOne': 'Please select at least one item',
  'modelTest.noModelForProtocol': 'No models available for this protocol',
  ...
  'settings.desc.auto_update_interval_hours': 'Auto-update check interval (integer hours, 0 = disabled, minimum 1 hour when enabled)',
